...
class SemanticKitti(Dataset):
  ...
  def __init__(self, root,    # directory where data is
              ...
              #  gt=True, training=False):            # send ground truth?
    ...
    for seq in self.sequences:
      ...
      scan_files.sort()
      self.scan_files.append(scan_files[-1])
  ...
  def __getitem__(self, index):
    ...
    if self.gt:
      scan = SemLaserScan(self.color_map,
                          ...
                          fov_down=self.sensor_fov_down, training=False) #modified by dhzd
      ...
      scan = LaserScan(project=True,
                       ...
                       W=self.sensor_img_W,
                       fov_up=self.sensor_fov_up,
                       fov_down=self.sensor_fov_down, training=False) #modified by dhz
                      #  fov_down=self.sensor_fov_down, training=self.training)
...
class Parser():
  ...
  def __init__(self,
    ...
    #                                    gt=self.gt, training=False) #modified by dhz
