...
class LaserScan:
  ...
  def __init__(self, project=False, H=64, W=1024, fov_up=3.0, fov_down=-25.0, training=False):
    ...
    self.training = False#training #modified by dhz
    self.reset()
...
class SemLaserScan(LaserScan):
  ...
  def colorize(self):
    ...
    print(self.sem_label.size)
    print(self.sem_color_lut.size)
    print(self.sem_label_color.size)

    self.inst_label_color = self.inst_color_lut[self.inst_label]
    self.inst_label_color = self.inst_label_color.reshape((-1, 3))
    # print(self.inst_label)
    # print(self.inst_color_lut)
    # print(self.inst_label_color)
